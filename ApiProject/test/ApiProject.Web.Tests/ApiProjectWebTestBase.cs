...
{
    public abstract class ApiProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ApiProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ApiProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ApiProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ApiProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ApiProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ApiProjectDbContext, Task<T>> func)
        {
            T result;
