...
import { Button, Card, Checkbox, Col, Input, Select, Tooltip } from 'antd';
        ...
        <Col className='QGschfHCeo'>
            ...
            >
                ...
                <div className='nRqxyzTkGx'>
                    <span className="ant-form-text">{L("Thay đổi mật khẩu", "COMMON")}</span>
                </div>
                <Form.Item
                ...
                <Form.Item
                    label={L("Xác Nhận", "COMMON")}
                    name="password"
                >
                    <div
                        className='hdndQMLNsc'>
                        <img src="" alt="" />
                        <Tooltip title={L("Thay đổi captcha mới", "COMMON")}>
                            <Button
                                type="primary"
                                icon={<RedoOutlined />}
                            />
